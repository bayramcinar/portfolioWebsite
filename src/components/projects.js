  ...
  return (
    <div id='projects'>
      ...
      <div className='projectList' style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", maxWidth: "80%", margin: "0 auto" }}>
        <ProjectBox img={exchange} name={"Exchange App"} explain={"I made an Exchange App by using HTML, CSS and JavaScript."} link={"http://exchangeapp.rf.gd/"} github={"https://github.com/bayramcinar/exchangeApp"}/>
